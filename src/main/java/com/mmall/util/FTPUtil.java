...
public class FTPUtil {
    ...
    private static String ftpIp = PropertiesUtil.getProperty("ftp.server.ip","119.29.217.28");
    private static String ftpUser = PropertiesUtil.getProperty("ftp.user","ftpuser");
    private static String ftpPass = PropertiesUtil.getProperty("ftp.pass","123456");
