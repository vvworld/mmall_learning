...
//        VO对象--value object
    ...
    public ServerResponse<PageInfo> getProductByKeywordCategory(String keyword, Integer categoryId, int pageNum, int PageSize,String orderBy) {
        ...
        if (categoryId != null) {
            ...
            categoryList = iCatrgoryService.selectCategoryAndChildrenById(categoryId).getData();
        }
        ...
        for (Product productItem : productList) {
            productListVoList.add(assembelProductListVo(productItem));
        }
