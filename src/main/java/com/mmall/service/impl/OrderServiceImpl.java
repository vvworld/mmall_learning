...
public class OrderServiceImpl implements IOrderService{
    ...
    public ServerResponse pay(Long ordrNo, Integer userId, String path) {
        Map<String,String> resultMap = Maps.newHashMap();
        Order order = orderMapper.selectByUserIdAndOrderNo(userId, ordrNo);
        if (order == null) {
        ...
        List<OrderItem> orderItemList = orderItemMapper.getByOrderNoUserId(ordrNo, userId);
...
//        goodsDetailList.add(goods2);
    ...
    private List<OrderVo> assembleOrderVoList(List<Order> orderList, Integer userId) {
        ...
        for (Order order : orderList) {
            ...
            orderVoList.add(assembelOrderVo(order,orderItemList));
        }
        return orderVoList;
    }
